...
public class WeChatUtils {
     ...
     * 素材上传接口
     */
    public String sendutil(String access_token,String openid,Long media_id) throws IOException {

        HashMap<String, String> map = new HashMap<>();
        map.put("touser",openid);
        map.put("mpnews","media_id:"+media_id);
        map.put("touser",openid);
        map.put("touser",openid);
        map.put("touser",openid);
        String s = HttpUtil.sendPost("https://api.weixin.qq.com/cgi-bin/message/mass/send?access_token=" + access_token, map);
        return s;
    }
